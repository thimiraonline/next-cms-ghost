...
export const ghostAPIUrl = process.env.CMS_GHOST_API_URL || 'https://androidwedakarayo.com'
export const ghostAPIKey = process.env.CMS_GHOST_API_KEY || 'c1d2cba0cdb6d4bac0fc6c8b02'
